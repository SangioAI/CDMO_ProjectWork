...
def seq_model(m, n, l, s, D, symmetry_breaking=True, implied_constraint=True, search='Linear', display_solution=False, timeout_duration=300, UB=True, partitionUB=False):
